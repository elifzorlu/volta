...
import WeeklyHabitStats from './components/WeeklyHabitStats';
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10 lg:py-12">
        ...
        {/* 2. Personalized Hero Message - Primary focal point */}
        <GreetingHeader />
        
        {/* 3. Brain Identity Section */}
        <BrainSignature />

        {/* Consistency Moments - Right under Brain Signature */}
        <ConsistencyMoments moments={consistencyMoments} />

        {/* 4. Daily Score Highlight - Single standout score */}
        {todayData &&
        <ProductivityScore
        ...
        {/* 5. Suggested Focus Windows - Immediate actionable guidance */}
        {sacredWindow &&
        <SacredFocusWindow
        ...
        {/* 6. Advanced/Personalized Insights - Human-centric recommendations */}
        ...
        {/* 8. Weekly Summary & Trends - End of page */}
        <WeeklySummary />
        <WeeklyHabitStats />

        {/* Quick Log Button - Utility action at bottom */}
        <div className="mb-6">
          <button
            onClick={() => navigate('/log')}
            className="w-full py-3 px-4 bg-transparent hover:bg-white/5 text-white font-medium rounded-lg transition-all duration-300 flex items-center justify-center gap-2 border border-white/20 hover:border-white/40">
